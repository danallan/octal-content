...
// agfk app & gen-utils
requirejs(["backbone", "octal/utils/utils", "octal/routers/router", "gen-utils","octal/models/aux-model", "jquery", "btouch", "sidr"], function(Backbone, Utils, AppRouter, GenPageUtils, AuxModel, $){
  "use strict";
