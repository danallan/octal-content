 ...
 */
define(["backbone", "jquery", "octal/views/explore-view", "octal/views/learning-view", "octal/views/quiz-view", "octal/views/apptools-view", "octal/views/loading-view", "octal/models/graph-data-model", "octal/models/quiz-model", "octal/models/user-data-model", "octal/utils/errors", "octal/views/error-view"],
			 function(Backbone, $, ExploreView, LearnView, QuizView, AppToolsView, LoadingView, GraphModel, QuestionModel, UserData, ErrorHandler, ErrorMessageView){
					 "use strict";
					 ...
					 return (function(){
							 ...
							 pvt.routeConsts = {
									 ...
									 qViewId: "quiz-view-wrapper", //id for main quiz view div
							 ...
							 return Backbone.Router.extend({
									 ...
									 nodeRoute: function(nodeId, paramsObj) {
											 ...
											 pQuizMode = routeConsts.pQuizMode,
											 ...
											 doRender = keyNodeChanged
													 ...
													 || (pvt.viewMode === pQuizMode && typeof thisRoute.qview === "undefined")
											 ...
											 preLoadViz = paramsObj[qViewMode] === pExploreMode || paramsObj[qViewMode]===pQuizMode; // async start loading Viz before the view, else load after the view
											 ...
											 function postNodePop() {
													 ...
													 case pQuizMode:
															 if (doRender){
																	 if(typeof thisRoute.eview === "undefined") {
																			 thisRoute.eview = new ExploreView({model: thisRoute.graphModel, appRouter: thisRoute});
																			 thisRoute.eview = thisRoute.eview.render();
																			 //thisRoute.showView(thisRoute.eview, doRender, "#" + routeConsts.qViewId);
																	 }
